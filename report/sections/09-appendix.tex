...
\todo[inline]{describe whats on the CD and reference git repos}
...
In \ac{ANML} it is not possible to inherit multiple types, so it is not possible to have an ingredient that is both choppable and fryable.
