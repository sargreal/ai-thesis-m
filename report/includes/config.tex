...
% setup packages needed for plotting
% \usepackage{tikz}
% \usepackage{pgfplots}
...
\fancyfoot[LO]{\footnotesize\sc Temporal HTN Planning with a Stream of Tasks -- Haase, Felix -- Masterarbeit}
\fancyfoot[RO]{\thepage}
...
\begin{minipage}[t]{15.5cm}
  ...
  \end{minipage}
  \begin{minipage}{3cm}
    \includegraphics[height=30mm]{includes/UB-Logo-neu_blau-cmyk}
  \end{minipage}
  % \hfill
% \hfill
% \begin{minipage}{3cm}
%     \includegraphics[height=26mm]{includes/logo}
% \end{minipage}
\end{minipage}\\[130pt]
{\LARGE #1}\\[24pt]
im Studiengang #2\\
...
\newcommand{\makedeclaration}[3]
{
	...
	%
      ...
      Des Weiteren erkläre ich, dass Inhalt und Wortlaut der beiden Fassungen (digital/in Papierform) identisch sind und zur Kenntnis genommen wurde, 
      dass die digitale Fassung einer durch Software unterstützten, anonymisierten Prüfung auf Plagiate unterzogen werden kann.
			\vspace*{1cm}
...
% Einstellungen für ANML-Code
\lstdefinelanguage{ANML}{
  keywords={forall,:decomposition,in,with,contains,type,constant,fluent,instance,action,variable,function,predicate,boolean,integer,duration,true,false,end,start,all},
  otherkeywords={:,!=,:->,:=,==,<,:in},
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
}

\lstdefinestyle{anmlStyle}{%
...
%
% neues environment für ANML-Sourcecode
% #1 = "caption={Hier eigene Überschrift}, label={Hier eigenes Label}"
\lstnewenvironment{anmlcode}[1][]{%
\lstset{style=anmlStyle,#1}%
}{}
%
% Befehl zum Einbinden von ANML-Sourcecode aus Datei
% #1 = Dateiname relativ zu src-Verzeichnis
% #2 = Überschrift
% #3 = Label
\newcommand{\anmlFile}[3]{%
   \lstinputlisting[%
     caption={#2},%
     label={#3},%
     style=anmlStyle]{#1}%
...
%
% Umgebung für Fließtext um Grafik
% #1 = Ausrichtung: r, l, i, ...
